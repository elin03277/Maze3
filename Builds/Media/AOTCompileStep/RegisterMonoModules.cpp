...
#define DLL_EXPORT
    ...
    extern gpointer*    mono_aot_module_TextMeshPro_5_6_Runtime_info; // TextMeshPro-5.6-Runtime.dll
...
DLL_EXPORT void RegisterMonoModules()
{
    ...
    mono_aot_register_module(mono_aot_module_TextMeshPro_5_6_Runtime_info);
